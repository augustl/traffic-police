...
(deftest basic-nested-handler-with-params
  (let [handler (t/handler
                 [["/foo" identity {:get echo-handler}
...
(deftest basic-middleware-wrapper
...
(deftest nested-middleware-wrapper
...
(deftest middleware-wrapper-runs-before-preconditions
  (let [wrap-test-appender (fn [handler]
                             (fn [req]
